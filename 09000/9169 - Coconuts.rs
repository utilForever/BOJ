...
fn main() {
    ...
    loop {
        ...
        let mut believes = vec![0; n];

        for i in 0..n {
            believes[i] = scan.token::<i64>();
        }
        ...
        for i in 0..n {
            maximum_flow.add_edge(source, i, believes[i]);
            maximum_flow.add_edge(i, sink, 1 - believes[i]);
        }
