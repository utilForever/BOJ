...
fn main() {
    ...
    for i in 0..n {
        for j in 0..n {
            ...
            match board[i][j] {
                'o' => {
                    maximum_flow.add_edge(source, idx, 1);
                    ...
                    for k in 0..4 {
                        ...
                        if board[y_next][x_next] == '.' {
                            maximum_flow.add_edge(idx, y_next * n + x_next, INF);
                        }
                    }
                }
                'x' => {
                ...
                '.' => {
                    maximum_flow.add_edge(idx, sink, 1);
                }
                _ => unreachable!(),
            }
        }
    ...
    writeln!(out, "{}", cnt_empty + cnt_white - flow).unwrap();
}
