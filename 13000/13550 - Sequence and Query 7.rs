...
static SIZE: usize = 1_000_001 / SQUARE + 10;
...
fn main() {
    ...
    let (n, k) = (scan.token::<usize>(), scan.token::<i32>());
    ...
    let mut pos = vec![LinkedList::new(); 1_000_001];
    let mut count = vec![0; 1_000_001];
