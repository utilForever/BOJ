...
fn main() {
    ...
    for i in 1..=t {
        ...
        points.insert(0, Point3::new(0.0, 0.0, 0.0));

        unsafe {
            let mut points1 = points.clone();
            let f1 = Point3::new(0.0, 0.0, 0.0);
            points1.push(Point3::new(5_000_000.0, 5_000_000.0, 5_000_000.0));
            ...
            for face in convex_hull1.faces.iter() {
                ...
                if a.is_equal(&f1) || b.is_equal(&f1) || c.is_equal(&f1) {
                    ret1 = true;
                    break;
                }
            }
            ...
            let f2 = Point3::new(0.0, 0.0, 0.0);
            points2.push(Point3::new(-5_000_000.0, -5_000_000.0, -5_000_000.0));
            ...
            for face in convex_hull2.faces.iter() {
                ...
                if a.is_equal(&f2) || b.is_equal(&f2) || c.is_equal(&f2) {
                    ret2 = true;
                    break;
                }
            }
