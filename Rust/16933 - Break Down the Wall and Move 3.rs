...
fn explore(
    ...
    while !queue.is_empty() {
        let (cur_x, cur_y, num_break, cur_time) = queue.pop_front().unwrap();
        ...
        for i in 0..4 {
            ...
            if maze[next_y as usize][next_x as usize] == '0' {
                if visited[next_y as usize][next_x as usize][num_break] == 0 {
                    ...
                    queue.push_back((next_x, next_y, num_break, cur_time + 1));
                }
            } else if maze[next_y as usize][next_x as usize] == '1' && num_break < k {
                if visited[next_y as usize][next_x as usize][num_break + 1] == 0 {
                    if cur_time % 2 == 1 {
                        queue.push_back((cur_x, cur_y, num_break, cur_time + 1));
                    } else {
                        visited[next_y as usize][next_x as usize][num_break + 1] = 1;
                        queue.push_back((next_x, next_y, num_break + 1, cur_time + 1));
                    }
                }
            }
        }
